...
1. Navigate to the 4-structured-outputs directory containing your agent folder.
...
```
Generate a professional email to my team about the upcoming project deadline that has been extended by two weeks.
```
